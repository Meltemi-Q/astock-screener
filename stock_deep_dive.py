...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<style>
	*{{box-sizing:border-box}}
	:root{{color-scheme:light;--bg:#f6f8fb;--text:#172033;--heading:#0f172a;--muted:#64748b;--surface:#fff;--surface-soft:#f8fafc;--border:#dbe4f0;--border-strong:#cbd5e1;--head:#eef2f7;--link:#2563eb;--hover:#f8fbff}}
	:root[data-theme="dark"]{{color-scheme:dark;--bg:#0f1115;--text:#e6e8eb;--heading:#f8fafc;--muted:#9aa4b2;--surface:#131820;--surface-soft:#1a1f29;--border:#232936;--border-strong:#2a3140;--head:#1a1f29;--link:#7fb3ff;--hover:#161b24}}
	...
	.nav-link{{display:inline-flex;align-items:center;min-height:34px;padding:6px 12px;border:1px solid var(--border-strong);border-radius:7px;background:var(--surface);color:var(--link);text-decoration:none;font-weight:600;font:inherit;cursor:pointer}}
	.nav-link.muted{{color:var(--muted)}}
	.nav-link:hover{{background:var(--surface-soft);border-color:var(--link);text-decoration:none}}
	...
	th{{background:var(--head);color:var(--muted);padding:9px 12px;text-align:left;border-bottom:2px solid var(--border-strong);position:sticky;top:0;font-size:12px}}
	...
	footer{{margin-top:30px;color:var(--muted);font-size:11px;border-top:1px solid var(--border);padding-top:12px}}
	</style></head><body>
	<div class="container">
	<nav class="topbar">
